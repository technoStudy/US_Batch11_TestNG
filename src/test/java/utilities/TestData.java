...
public class TestData {
    ...
    @DataProvider(name = "accountAutomationExercise")
    public Object[][] account() {
        Object[][] testDate = {
                {"xyz12", "xyz3214k@gmail.com", "1234", "osman", "osman", "GermanIT", "Munich", "Canada", "Munich", "Munich", "1234", "1234"},
                {"catburak", "cayt@gmail.com", "1234", "burak", "burak", "GermanIT", "Munich", "Canada", "Munich", "Munich", "1234", "1234"},
                {"cresty", "amd3290@gmail.com", "1234", "amdsad", "dereks", "GermanIT", "Munich", "Canada", "Munich", "Munich", "1234", "1234"}
    ...
    //FirstName,LastName,MobileNo,Password,month,day,year

    @DataProvider(name = "createFacebookAccount")
    public Object[][] createaacount() {
        Object[][] testData = {
                {"", "Naz", "+38630335147", "ervanaz2012", "Feb", "15", "2000"},//without name
                {"Erva", "", "+38630335147", "ervanaz2012", "Feb", "15", "2000"},//without last name
                {"Erva", "Naz", "", "ervanaz2012", "Feb", "15", "2000"}//without mobile no
        };
        return testData;
    }
